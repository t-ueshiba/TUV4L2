/*
 * test1394camera: test program controlling an V4L2 1394-based Digital Camera
...
void
MyV4L2CameraArray::pushFileSelection(GtkWidget* filesel)
{
    _filesel = filesel;
}

GtkWidget*
MyV4L2CameraArray::popFileSelection()
{
...
MyV4L2CameraArray::swap(size_t i, size_t j)
{
    ...
    g_snprintf(guid, 20, "%s", _cameras[j].dev().c_str());
